...
**ハンズオン終了後のリソース削除手順は[こちら](./delete-resources/README.md)をご参照ください。
...
2. IAMダッシュボードの左側ナビゲーションメニューから [ロール] を選択し、表示画面上部の [ロールを作成] ボタンを押下します。
...
9 [IAMロールを変更]にて、IAMロール名として先程作成した [cnos-cloud9-role] を選択し [IAMロールの更新] ボタンを押下します。
